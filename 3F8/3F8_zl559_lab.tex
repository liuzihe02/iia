...
\begin{itemize}
    ...
    \item \textbf{Large $l$ (e.g.\ $l = 1$):}
          ...
          two classes. The final train and test log-likelihoods are $-0.2701$
...
producing large gradient magnitudes that demand a smaller learning rate to avoid divergence. [show stuff on oscillations...]
