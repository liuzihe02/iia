...
The data is split randomly\footnote{A fixed random seed of 1 was used for reproducibility.} into training ($N_{\text{train}} = 800$)
...
\end{verbatim}
We train the classifier with learning rate $\eta = 0.001$ for $T = 100$
...
$\eta = 0.001$ is an appropriate learning rate.
