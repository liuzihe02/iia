...
\begin{frame}{Hydrodynamic Drag}
  ...
  \begin{itemize}
    \item Diameter: $D \approx 0.3$ m, Length: $L \approx 1.2$ m
  ...
  \begin{itemize}
    \item \textbf{At 1 m/s cruise} $C_D = 0.32$: $F_D = 13.5$ N
    \item \textbf{At 4 m/s peak} $C_D = 0.28$: $F_D = 188$ N
  \end{itemize}
...
\begin{frame}{Power Requirements and Thruster Efficiency}
  ...
  \textit{4 m/s requires 1.4 kW propulsion power (30× cruise power)}
...
\begin{frame}{Complete System Power Budget}
  ...
  \centering
  $P_{avg} = 356 \text{ W}$ (Accounting for mission profile)

  \note{This power budget clarifies that the 30W payload specification includes ALL payload components: camera (1.1W), sonar (2-5W), and lighting (10-20W adjustable). The subtotal is 13-26W which is well within the 30W budget. Propulsion dominates the total power at peak speed (1,415W total, of which 1,367W is propulsion). The mission profile assumes 80 percent of time at cruise, 20 percent at peak for sprints. This gives an average power of 356W which determines our battery requirements.}
\end{frame}

\begin{frame}{Battery Sizing}
  \textbf{Energy Requirements:}
  $$E = P_{avg} \times t = 356 \text{ W} \times 2 \text{ h} = 712 \text{ Wh required}$$
...
\begin{frame}{Requirements Verification}
  \begin{table}
    ...
    \begin{tabular}{lccl}
      ...
      Endurance                    & 2 hours                & 3.4 hrs (mixed)   & Met             \\
      Cruise speed                 & 1 m/s                  & 1 m/s             & Met             \\
      Peak speed                   & 4 m/s                  & 4 m/s             & Met             \\
      Payload power                & 30W                    & 26W peak (all)    & Met             \\
      \midrule
