...
**Specifications from Datasheet:**[1]
- **Weight**: 17 kg in air[1]
- **Dimensions**: Torpedo-shaped, length/diameter ratio ~5:1 (estimated 1.0m × 0.2m)[1]
- **Depth Rating**: 500m (2× your requirement)[1]
- **Endurance**: 8-10 hours no payload, 30 hours claimed with extended battery[1]
- **Battery**: Alkaline primary batteries (non-rechargeable)[1]
- **Propulsion**: Single thruster with control fins[1]
- **Navigation**: GPS, depth sensor, compass (no DVL standard)[1]
- **Communication**: Iridium satellite, WiFi, acoustic modem optional[1]
- **Payload Bay**: Available for sensors/cameras[1]
- **Cost**: $50,000-80,000 estimated (not published, based on market positioning)[1][2]

**Analysis**: The ecoSUB achieves long endurance through very low cruise speed (~1-1.5 m/s estimated) and alkaline batteries[1][2]. The 17 kg weight is impressive but provides no speed performance data. For cable inspection requiring 4 m/s capability, ecoSUB likely underpowered[1][2].

**Boxfish AUV (Blue Robotics-based Platform)**[49]

**Key Features:**[49]
- **Weight**: Exactly 25 kg with saltwater ballast system[49]
- **Depth Rating**: 300m standard, 600m optional[49]
- **Endurance**: Up to 10 hours[49]
- **Propulsion**: 8× Blue Robotics T200 thrusters (3D-vectored)[49]
- **Control**: 6 DOF (degrees of freedom) - full hover capability[49]
- **Battery**: 600 Whr Lithium Polymer[49]
- **Computer**: NVIDIA Jetson Xavier running ROS 2[49]
- **Sensors**: Stereo cameras, depth sonar, IMU/AHRS, pressure sensor[49]
- **Communication**: WiFi, Iridium optional, acoustic modem optional[49]
- **Use Case**: Underwater inspection with station-keeping[49]
- **Cost**: $80,000-150,000 estimated[49]

**Analysis**: Boxfish prioritizes maneuverability (hovering, tight turns) over speed[49]. Eight thrusters enable omnidirectional movement but consume substantial power. Speed likely limited to 2-3 m/s sustained[49]. The platform demonstrates feasibility of 25 kg at 300m depth with 10-hour endurance when not requiring 4 m/s performance[49].

**OceanServer Iver3 Standard (L3Harris)**[50]

**Published Specifications:**[50]
- **Weight**: 27 kg baseline, 34 kg typical, 39 kg maximum (depending on payload)[50]
- **Depth Rating**: 100m standard (300m optional version available)[50]
- **Endurance**: 8 hours standard, 14 hours extended[50]
- **Speed**: 1.3 m/s (2.5 knots) cruise[50]
- **Dimensions**: 1.5m length × 0.14m diameter[50]
- **Propulsion**: Single thruster with control fins (pitch/yaw)[50]
- **Battery**: 784 Whr rechargeable lithium-ion[50]
- **Navigation**: GPS, depth, compass, optional DVL/INS[50]
- **Sensors**: Side-scan sonar, forward-looking sonar, CTD, camera options[50]
- **Communication**: Iridium, WiFi, acoustic modem, radio modem[50]
- **Payload Bay**: Modular sections for sensors[50]
- **Missions Completed**: 3,000+ successful autonomous missions[50]
- **Units Sold**: 375+ vehicles worldwide[50]
- **Cost**: $50,000 base price (2024)[50]

**Analysis**: Iver3 represents proven, mature technology with extensive operational history[50]. However, it exceeds your weight target and provides only 100m standard depth rating (though 300m version exists)[50]. The 1.3 m/s speed is insufficient for your 4 m/s requirement[50]. The $50K price point reflects commercial reliability and support but offers less raw performance per dollar than custom build[50].
...
**Cost Analysis:**[5][6]
- 3× Blue Robotics 18Ah batteries: 3 × $400 = $1,200[5][6]
- Battery housing (3" enclosure): $250[44]
- Power distribution board: $100
- **Total power system**: $1,550

This consumes 4.1 kg + 0.5 kg (housing/wiring) = **4.6 kg** (18.4% of 25 kg budget)[5][6][44].
...
| Syntactic foam (buoyancy)[2] | 2 kg | $100/kg | $200 | Trelleborg/DeepSea[2] |
...
|---------|------|---------|
| Nortek DVL1000[21] | +$20,000 | Precision navigation[21] |
| SubC Rayfin camera[38] | +$12,000 | 4K imaging[38] |
| VectorNav VN-100 IMU[24] | +$1,200 | Better attitude estimation[24] |
| 4th battery (22.2V 28Ah)[5] | +$1,500 | Extended endurance[5] |

---

## 11. Conclusion: Feasibility Assessment
...
✓ 250m depth rating (proven with COTS components[44])
✓ 30W payload (camera + sonar + lighting within budget[35][40][42])
✓ <25 kg mass (tight but achievable: 23-26 kg realistic)
✓ 2-hour endurance at cruise speeds (1-2 m/s[5][6])

**Challenging Specifications:**
⚠ 4 m/s peak speed (achievable but requires 1.3 kW propulsion power[7][8])
⚠ 2-hour endurance at 4 m/s (NOT feasible - would require 2.7 kWh battery at 10+ kg[5][6])

**Recommended Specification Interpretation:**

Your vehicle should be capable of:
- **Sustained cruise**: 1-2 m/s for 3+ hours on 799 Wh battery[5][6]
- **Peak sprint**: 4 m/s for 10-15 minutes (cable tracking, maneuvering)[7][8]
- **Mixed mission**: 2-hour duration with 10% peak, 30% medium, 60% cruise operation[5][6]
...
- **DIY Build**: $10,000-23,000 (without/with acoustic modem)[All refs]
- **Commercial Equivalent**: $50,000-150,000[1][49][50]
- **Cost Ratio**: 20-25% of commercial pricing
- **Capability**: Superior speed performance to commercial options in this weight class[1][49][50]
...
- **Risk Level**: Medium (proven components reduce technical risk[7][14][44])
- **Educational Value**: Excellent multi-disciplinary engineering exercise

**Key Success Factors:**

1. **Manage the speed-endurance-weight triangle carefully**[3][4][5][6] - you cannot optimize all three simultaneously
2. **Use proven commercial components**[7][14][44] (Blue Robotics ecosystem) rather than custom designs
3. **Test incrementally** - validate pressure, buoyancy, and speed in phases[44][46]
...
**Proceed with the project** using the specifications and component selections outlined in this study. The design is technically sound, economically viable, and educationally valuable. The 4 m/s peak speed is ambitious but achievable with four T200 thrusters[7][8] and proper hydrodynamic optimization[3][4].

For a Cambridge Engineering Tripos Part IIA Extension Activity, this presents an excellent balance of:
- **Ambition**: Pushing beyond typical commercial AUV performance[1][49][50]
- **Achievability**: Using proven components and established engineering principles[7][14][44]
...
The project exercises mechanical engineering (pressure vessels[43][46], structures), electrical engineering (power systems[5], motor control[12]), computer engineering (autonomy[14], sensors[16][21]), and systems integration[All refs] - exactly the comprehensive experience expected in a feasibility study.
