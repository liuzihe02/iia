...
%TODO: Explain key design choices:
%TODO:   - 50 MHz clock divided via 29-bit counter (250M cycles = 5s, 500M cycles = 10s)
%TODO:   - 2-bit state encoding: G=0, Y=1, R=2
%TODO:   - Active-low reset (negedge) -- matches DE1-SoC push-buttons
%TODO:   - 5-bit output vector mapping: {veh_G, veh_Y, veh_R, ped_G, ped_R}
...
%TODO: Report Compiler Flow Summary figures from Quartus
%TODO: Fill in actual values below
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lc}
        ...
        Resource       & Count         \\
        \midrule
        Logic Elements & \textbf{TODO} \\
        Registers      & \textbf{TODO} \\
        Pins           & \textbf{TODO} \\
        \bottomrule
    \end{tabular}
\end{table}

%TODO: Comment on whether these numbers are reasonable for the circuit complexity
%TODO: (handout reference: 31 LEs, 35 registers, 8 pins for the example code)
...
%TODO: Comment on configurability of pin assignments in Quartus
%TODO: Note: all on-board LEDs are RED; comment on this limitation
...
%TODO: Compilation Report Screenshot
% \includegraphics[width=\textwidth]{compilation_report.png}
